...
((SELECT id FROM kor_search_word_transform WHERE keyword = 'your'), '너의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'his'), '그의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'her'), '그녀의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'its'), '그것의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'our'), '우리의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'their'), '그들의'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'mine'), '나의 것'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'yours'), '너의 것'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'hers'), '그녀의 것'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'ours'), '우리의 것'),
((SELECT id FROM kor_search_word_transform WHERE keyword = 'theirs'), '그들의 것'),
